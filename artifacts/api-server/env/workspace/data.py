...
SEED_EMAILS = [
    ...
    },
    {
        ...
        "body": "Hey,\n\nCan we sync on budget planning this Friday at 10:00 AM?\n\nThanks,\nMike",
...
SEED_DOCUMENTS = [
    {"id": "doc_001", "name": "project_proposal.pdf", "folder": "Inbox", "type": "PDF", "size": "2.4 MB", "modified": "2026-03-28"},
    {"id": "doc_002", "name": "leave_policy_2026.pdf", "folder": "Inbox", "type": "PDF", "size": "1.1 MB", "modified": "2026-03-27"},
    {"id": "doc_003", "name": "q1_report.xlsx", "folder": "Finance", "type": "Spreadsheet", "size": "3.8 MB", "modified": "2026-03-25"},
    {"id": "doc_004", "name": "onboarding_checklist.docx", "folder": "HR", "type": "Document", "size": "0.5 MB", "modified": "2026-03-20"},
    {"id": "doc_005", "name": "architecture_diagram.png", "folder": "Engineering", "type": "Image", "size": "4.2 MB", "modified": "2026-03-22"},
]
